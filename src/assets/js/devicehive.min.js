...
const API=require("./API"),ApiMap=require("./transportResolvers/ApiMap");class DeviceAPI extends API{get(e){return this.send(ApiMap.getDevice,{deviceId:e})}list(e){return this.send(ApiMap.listDevice,e.toObject())}count(e){return this.send(ApiMap.countDevice,e.toObject())}add(e){return this.send(ApiMap.addDevice,{deviceId:e.id},e.toObject())}delete(e){return this.send(ApiMap.deleteDevice,{deviceId:e})}}module.exports=DeviceAPI;

},{"./API":171,"./transportResolvers/ApiMap":181}],174:[function(require,module,exports){
const API=require("./API"),ApiMap=require("./transportResolvers/ApiMap");class DeviceCommandAPI extends API{get(e,t){return this.send(ApiMap.getCommand,{deviceId:e,commandId:t})}list(e){return this.send(ApiMap.listCommand,e.toObject())}insert(e,t){return this.send(ApiMap.insertCommand,{deviceId:e},t.toObject())}update(e){return this.send(ApiMap.updateCommand,{deviceId:e.deviceId,commandId:e.id},e.toObject())}poll(e){return this.send(ApiMap.pollCommand,e.toObject())}pollMany(e){return this.send(ApiMap.pollManyCommand,qcommandPollManyQueryuery.toObject())}wait(e,t){return this.send(ApiMap.waitCommand,{deviceId:e,commandId:t})}subscribe(e){return this.send(ApiMap.subscribeCommand,e.toObject())}unsubscribe(e){return this.send(ApiMap.unsubscribeCommand,{subscriptionId:e})}}module.exports=DeviceCommandAPI;

},{"./API":171,"./transportResolvers/ApiMap":181}],175:[function(require,module,exports){
const API=require("./API"),ApiMap=require("./transportResolvers/ApiMap");class DeviceNotificationAPI extends API{get(i,t){return this.send(ApiMap.getNotification,{deviceId:i,notificationId:t})}list(i){return this.send(ApiMap.listNotification,i.toObject())}insert(i){return this.send(ApiMap.insertNotification,{deviceId:i.deviceId},i.toObject())}poll(i){return this.send(ApiMap.pollCommand,i.toObject())}pollMany(i){return this.send(ApiMap.pollManyCommand,i.toObject())}subscribe(i){return this.send(ApiMap.subscribeCommand,i.toObject())}unsubscribe(i){return this.send(ApiMap.unsubscribeCommand,{subscriptionId:i})}}module.exports=DeviceNotificationAPI;

},{"./API":171,"./transportResolvers/ApiMap":181}],176:[function(require,module,exports){
const API=require("./API"),ApiMap=require("./transportResolvers/ApiMap");class DeviceTypeAPI extends API{get(e){return this.send(ApiMap.getDeviceType,{deviceTypeId:e})}list(e){return this.send(ApiMap.listDeviceType,e.toObject())}count(e){return this.send(ApiMap.countDeviceType,e.toObject())}insert(e){return this.send(ApiMap.addDeviceType,{},e.toObject())}update(e){return this.send(ApiMap.updateDeviceType,{deviceTypeId:e.id},e.toObject())}delete(e){return this.send(ApiMap.deleteDeviceType,{deviceTypeId:e})}}module.exports=DeviceTypeAPI;

},{"./API":171,"./transportResolvers/ApiMap":181}],177:[function(require,module,exports){
const API=require("./API"),ApiMap=require("./transportResolvers/ApiMap");class NetworkAPI extends API{get(e){return this.send(ApiMap.getNetwork,{networkId:e})}list(e){return this.send(ApiMap.listNetwork,e.toObject())}count(e){return this.send(ApiMap.countNetwork,e.toObject())}insert(e){return this.send(ApiMap.addNetwork,{},e.toObject())}update(e){return this.send(ApiMap.updateNetwork,{networkId:e.id},e.toObject())}delete(e){return this.send(ApiMap.deleteNetwork,{networkId:e})}}module.exports=NetworkAPI;

},{"./API":171,"./transportResolvers/ApiMap":181}],178:[function(require,module,exports){
...
},{"../../utils/Utils":210}],184:[function(require,module,exports){
...
},{"./base/Transport":209,"isomorphic-fetch":107,"randomstring":135}],208:[function(require,module,exports){
const Transport=require("./base/Transport"),randomString=require("randomstring"),WebSocket=require("universal-websocket-client");class WS extends Transport{static get TYPE(){return"ws"}constructor({mainServiceURL:e}){super(),this.type=WS.TYPE,this.isOpend=!1,this.socket=new WebSocket(e),this.socket.addEventListener("message",e=>{try{let t=JSON.parse(e.data);t.requestId?this.emit(t.requestId,t):this.emit("message",t)}catch(e){console.warn(e)}})}_getSocket(){return new Promise(e=>{!0===this.isOpend?e(this.socket):this.socket.addEventListener("open",()=>{this.isOpend=!0,e(this.socket)})})}authenticate(e){this.send({action:"authenticate",token:e})}send(e){return this._getSocket().then(()=>{const{requestId:t=randomString.generate()}=e;return e.requestId=t,new Promise((s,r)=>{this.socket.send(JSON.stringify(e));const n=i=>{i.requestId===t&&(this.removeListener(e.requestId,n),"success"===i.status?s(i):r(i))};this.addListener(e.requestId,n)})})}}module.exports=WS;

},{"./base/Transport":209,"randomstring":135,"universal-websocket-client":165}],209:[function(require,module,exports){
const EventEmitter=require("events");class Transport extends EventEmitter{authenticate(e){}send(){}}module.exports=Transport;

},{"events":86}],210:[function(require,module,exports){
